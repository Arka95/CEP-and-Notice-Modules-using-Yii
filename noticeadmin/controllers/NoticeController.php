...
{public $layout='//layouts/noticeUserLayout';
    ...
    {
        return array(
                        array('label'=>'User','icon'=>'edit', 'url'=>array('/noticeadmin/notice/')),
                        '',
                        array('label'=>'NOTICE'),
                        '',
                      
                        array('label'=>'View Notices', 'url'=>array('/noticeadmin/notice/viewNotice')),
